...
function Badges({ uid, habits, onClose }) {
    ...
    return (
        <div className="badges-overlay">
            <div className="badges-popup" role="dialog" aria-label="Badges">
                ...
                <div className="badges-header">
                    ...
                    <div className="badges-summary">
                        ...
                        <div className="badges-summary-pill">
                            <div className="pill-num">Badges Yet to Complete: {totalCount - earnedCount}</div>
                        </div>
                        ...
                        <div className="badges-summary-pill">
                            <div className="pill-num">
                                Badges Completed: {totalCount > 0 ? Math.round((earnedCount / totalCount) * 100) : 0}%
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="badges-body">
                    {loading ? (
                        ...
                        <>
                            <div className="badges-section-title earned-title">Earned Badges</div>
                            ...
                            {earnedCount === 0 && (
                                <div className="badges-empty">No badges earned yet. Keep grinding!</div>
                            )}

                            <div className="badges-divider" />

                            <div className="badges-section-title locked-title">Badges Yet to be Earned</div>
                            {CATEGORIES.map(({ key, label }) => {
